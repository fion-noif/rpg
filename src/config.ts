...
export const config = {
  ...
  // The zone an event's start/end *dates* are meant in, and therefore the zone a mechanic
  // link's expiry is computed in (src/mechanics.ts). Dates are calendar days, not instants:
